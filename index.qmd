...
A rounded image with `.rounded-circle.lightbox` moved to the margin.
:::
...
In the example below I use my own `mbutils` branding utilities.

[^brand.yml]: See [brand.yml](https://posit-dev.github.io/brand-yml/pkg/r/reference/index.htmll) package documentation for details.
...
My utility package [`mbutils`](https://mbacou.github.io/mbutils) also includes a fully-themed ggplot replacement with `brand_on()`.
